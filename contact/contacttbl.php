                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                           <a href="../user/usertbl.php"><i class="fa fa-table nav_icon"></i>User</a><br>
                                    ...
                                    <a href="contacttbl.php"><i class="fa fa-table nav_icon"></i>Contact</a><br>
    ...
    <table class="table"id="dataTables">
      <thead>
        <tr>
          ...
          <th>Subject<span class="glyphicon glyphicon-sort"></span></th>
          <th>Message<span class="glyphicon glyphicon-sort"></span></th>
