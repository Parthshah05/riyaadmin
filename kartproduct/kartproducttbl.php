...
<div class="navbar-header">
                        ...
                        <li>
                         ...
                         <li>       
                           ...
                           <a href="../user/usertbl.php"><i class="fa fa-table nav_icon"></i>User</a><br>
                                    ...
                                    <a href="kartproducttbl.php"><i class="fa fa-table nav_icon"></i>Kart-Product</a><br>
    ...
    <table class="table"id="dataTables">
      <thead>
        <tr>
          <th>Product<span class="glyphicon glyphicon-sort"></span></th>
      ...
      while($row=$res->fetch_assoc())
{
       ...
       echo '<tr class="success">';
           ...
           echo '<td> <a href="delete.php?id='.$row["kart_id"].'"><span class="glyphicon glyphicon-trash"></span></a></td>';
