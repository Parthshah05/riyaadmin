...
<div class="navbar-header">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <a href="../user/usertbl.php"><i class="fa fa-table nav_icon"></i>User</a><br>
                                    ...
                                    <a href="producttbl.php"><i class="fa fa-table nav_icon"></i>Product</a><br>
    ...
    <table class="table"id="dataTables">
      <thead>
        <tr>
          <th>Product Name<span class="glyphicon glyphicon-sort"></span></th>  
      ...
      while($row=$res->fetch_assoc())
{
       ...
       echo '<tr class="success">';
           ...
           echo '<td> <a href="delete.php?id='.$row["product_id"].'"><span class="glyphicon glyphicon-trash"></span></a>
           <a href="update.php?id='.$row["product_id"].'"> | <span class="glyphicon glyphicon-pencil"></span></a></td>';
...
<button type="button"  class="btn btn-primary" ><a href="insert.php">Insert</a></button>
  ...
  <div class="copy_layout">
      <p>Copyright &copy; 2019 Riya Foods. All Rights Reserved | Design by Parth Shah</a> </p>
  </div>
   </div>
      </div>
      <!-- /#page-wrapper -->
